...
CAPABILITY_PATHS=(
  'agent-os/src/agent_os/policies/'
  'agent-os/src/agent_os/mcp_gateway'
  'agent-os/src/agent_os/approvals'
  'agent-mesh/src/agentmesh/identity/'
  'agent-mesh/src/agentmesh/trust/'
  'agent-mesh/src/agentmesh/encryption/'
  'agent-runtime/src/agent_runtime/rings/'
  'agent-runtime/src/agent_runtime/kill_switch'
  'agent-runtime/src/agent_runtime/saga'
