...
- When documenting repo layout, treat standalone language SDKs/packages at the repository root as a
  valid first-party pattern. Use `agent-governance-python/` as the canonical Python package path,
