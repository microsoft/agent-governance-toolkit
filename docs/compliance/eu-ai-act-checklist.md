...
- **Awesome EU AI Act**: See [`GenAI-Gurus/awesome-eu-ai-act`](https://github.com/GenAI-Gurus/awesome-eu-ai-act) for a curated map of EU AI Act resources, including official sources, implementation references, standards, templates, and agent governance tools.
