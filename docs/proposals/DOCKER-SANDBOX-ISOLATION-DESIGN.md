...
| `AzureSandboxProvider` | Azure Container Apps sandboxes (managed) | Container-level on Azure-managed infrastructure with egress proxy | [AZURE-SANDBOX-ISOLATION-DESIGN.md](./AZURE-SANDBOX-ISOLATION-DESIGN.md) |
