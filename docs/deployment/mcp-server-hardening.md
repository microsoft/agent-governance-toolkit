...
Minimal ASP.NET Core Kestrel example:
...
builder.WebHost.ConfigureKestrel(options =>
{
    options.ConfigureHttpsDefaults(https =>
    {
        ...
        {
            // Validate the client certificate against your trusted CA chain.
...
- Enable the Kata Container node pool described in the [AKS documentation](https://learn.microsoft.com/azure/aks/) for VM-level isolation.
