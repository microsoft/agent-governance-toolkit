...
| **Antigravity CLI governance** | [`@microsoft/agent-governance-antigravity-cli`](agent-governance-antigravity-cli/) | `npm install -g @microsoft/agent-governance-antigravity-cli && agt-antigravity install` |
