...
| **Analysis** | [What Makes AGT Unique](docs/analysis/what-makes-agt-unique.md) -- deep dive on the ACS runtime, identity model, and why code-level enforcement matters |
