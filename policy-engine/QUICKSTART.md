...
| Node | `npm install "$ACS_KIT"/artifacts/agent-control-specification-0.3.1-beta.1.tgz "$ACS_KIT"/artifacts/agent-control-specification-linux-x64-gnu-0.3.1-beta.1.tgz "$ACS_KIT"/artifacts/agent-control-specification-opa-linux-x64-0.3.1-beta.1.tgz` |
| .NET | `dotnet add package AgentControlSpecification --version 0.3.1-beta.1 --source "$ACS_KIT/artifacts"` |
...
| Node | `npm init -y && npm install "$ACS_KIT"/artifacts/agent-control-specification-0.3.1-beta.1.tgz "$ACS_KIT"/artifacts/agent-control-specification-linux-x64-gnu-0.3.1-beta.1.tgz "$ACS_KIT"/artifacts/agent-control-specification-opa-linux-x64-0.3.1-beta.1.tgz && node -e "const acs=require('agent-control-specification'); console.log(typeof acs.AgentControl)"` |
| .NET | `dotnet new console -n AcsSmoke && cd AcsSmoke && dotnet add package AgentControlSpecification --version 0.3.1-beta.1 --source "$ACS_KIT/artifacts" && dotnet build` |
