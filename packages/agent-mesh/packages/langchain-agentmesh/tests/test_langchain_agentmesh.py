...
class TestCMVKIdentity:
    ...
    def test_generate_identity(self):
        ...
        identity = CMVKIdentity.generate(agent_name="test-agent", capabilities=["read", "write"])
    ...
    def test_has_capability(self):
        ...
        identity = CMVKIdentity.generate(agent_name="test-agent", capabilities=["read", "search"])
    ...
    def test_wildcard_capability(self):
        ...
        identity = CMVKIdentity.generate(agent_name="admin-agent", capabilities=["*"])
...
class TestTrustHandshake:
    ...
    def test_verify_peer_success(self):
        ...
        result = handshake.verify_peer(
            peer_card, required_capabilities=["analyze"], min_trust_score=0.5
        )
