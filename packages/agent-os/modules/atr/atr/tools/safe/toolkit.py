...
def create_safe_toolkit(
    preset: str = "standard", config: Optional[Dict[str, Any]] = None
) -> Dict[str, Any]:
    """
    ...
    if preset == "minimal":
        ...
        tools["calculator"] = CalculatorTool(precision=config.get("precision", 15))
        tools["datetime"] = DateTimeTool(default_timezone=config.get("timezone", "UTC"))
        tools["text"] = TextTool(max_length=config.get("max_text_length", 100000))
        ...
        tools["files"] = FileReaderTool(
            ...
            allowed_extensions=config.get(
                "allowed_extensions", [".txt", ".json", ".yaml", ".yml", ".md", ".csv", ".xml"]
            ),
            max_file_size=config.get("max_file_size", 1_000_000),
        )
        tools["json"] = JsonParserTool(max_size=config.get("max_json_size", 1_000_000))
        ...
        tools["json"] = JsonParserTool(
            max_size=config.get("max_json_size", 100_000), max_depth=config.get("max_depth", 20)
        )
        ...
        tools["json"] = JsonParserTool(max_size=config.get("max_json_size", 10_000_000))
        tools["calculator"] = CalculatorTool(precision=config.get("precision", 15))
        tools["datetime"] = DateTimeTool(default_timezone=config.get("timezone", "UTC"))
        tools["text"] = TextTool(max_length=config.get("max_text_length", 1_000_000))
