...
class JsonParserTool:
    ...
    def _check_size(self, data: str, name: str = "input"):
        ...
        if len(data) > self.max_size:
            raise ValueError(f"{name} too large: {len(data)} chars. Maximum: {self.max_size}")
    ...
    def parse_json(self, data: str) -> Dict[str, Any]:
        ...
        return {"success": True, "data": parsed, "type": type(parsed).__name__}
    ...
    def parse_yaml(self, data: str) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": False, "error": f"Invalid YAML: {e}", "data": None}
    ...
    def to_json(
        self, data: Any, indent: Optional[int] = 2, sort_keys: bool = False
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {"success": True, "json": result, "size": len(result)}
        except (TypeError, ValueError) as e:
            return {"success": False, "error": f"Cannot serialize: {e}", "json": None}
    ...
    def to_yaml(self, data: Any, default_flow_style: bool = False) -> Dict[str, Any]:
        """
        ...
        try:
            result = yaml.safe_dump(data, default_flow_style=default_flow_style, allow_unicode=True)
            ...
            return {"success": True, "yaml": result, "size": len(result)}
        except yaml.YAMLError as e:
            return {"success": False, "error": f"Cannot serialize: {e}", "yaml": None}
    ...
    def query(self, data: Any, path: str) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {"success": True, "value": current, "path": path}
        except (KeyError, IndexError, ValueError) as e:
            return {"success": False, "error": f"Path not found: {e}", "value": None}
