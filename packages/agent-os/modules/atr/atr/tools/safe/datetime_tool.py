...
class DateTimeTool:
    ...
    @tool(
        name="datetime_now", description="Get the current date and time", tags=["datetime", "safe"]
    )
    ...
    def parse(self, date_string: str, format: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    def format(self, iso_datetime: str, format: str = "human") -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {"success": True, "formatted": formatted, "format_used": fmt}
    ...
    def diff(self, datetime1: str, datetime2: str) -> Dict[str, Any]:
        """
    ...
    def convert_timezone(self, iso_datetime: str, to_timezone: str) -> Dict[str, Any]:
        """
