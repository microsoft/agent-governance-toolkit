...
class CalculatorTool:
    ...
    def __init__(self, precision: int = 15, max_value: float = 1e308, allow_complex: bool = False):
        """
    ...
    def evaluate(
        self, expression: str, variables: Optional[Dict[str, Union[int, float]]] = None
    ) -> Dict[str, Any]:
        """
        ...
        for char in clean_expr:
            if char not in allowed_chars:
                return {"success": False, "error": f"Invalid character: '{char}'", "result": None}
        ...
        try:
            ...
            return {"success": False, "error": f"Syntax error: {e}", "result": None}
        except (ValueError, TypeError, OverflowError, ZeroDivisionError) as e:
            return {"success": False, "error": str(e), "result": None}
        except Exception as e:
            return {"success": False, "error": f"Calculation error: {e}", "result": None}

    @tool(name="add", description="Add two or more numbers", tags=["math", "arithmetic", "safe"])
    ...
    @tool(name="multiply", description="Multiply numbers", tags=["math", "arithmetic", "safe"])
    ...
    @tool(name="divide", description="Divide numbers (a / b)", tags=["math", "arithmetic", "safe"])
    ...
    @tool(name="sqrt", description="Calculate square root", tags=["math", "safe"])
