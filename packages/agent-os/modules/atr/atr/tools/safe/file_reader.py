...
class FileReaderTool:
    ...
    def read_file(
        self, path: str, encoding: Optional[str] = None, max_lines: Optional[int] = None
    ) -> Dict[str, Any]:
        """
    ...
    def list_directory(
        self, path: str, pattern: str = "*", recursive: bool = False, include_hidden: bool = False
    ) -> Dict[str, Any]:
        """
    ...
    @tool(
        name="file_info", description="Get metadata about a file", tags=["file", "metadata", "safe"]
    )
