...
class DockerExecutor(Executor):
    ...
    def __init__(
        ...
        try:
            ...
            raise ImportError(
                "docker package is required for DockerExecutor. Install it with: pip install docker"
            )
    ...
    def _ensure_image(self) -> None:
        ...
        try:
            ...
            try:
                ...
                raise ExecutorError(f"Failed to pull Docker image '{self.image}': {str(e)}") from e
