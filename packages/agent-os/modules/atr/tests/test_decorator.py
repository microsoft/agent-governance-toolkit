...
def test_register_decorator_with_complex_types():
    ...
    def complex_func(
        items: List[str], mapping: Dict[str, int], optional_list: Optional[List[int]] = None
    ) -> List[str]:
