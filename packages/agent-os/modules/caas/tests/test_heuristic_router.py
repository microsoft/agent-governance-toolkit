...
def test_long_queries_without_keywords():
    ...
    long_query = (
        "Can you tell me more about the implementation details of this feature and how it works?"
    )
...
def test_priority_greetings_over_keywords():
    ...
    assert decision.model_tier == ModelTier.CANNED, "Greetings should have highest priority"
...
def test_confidence_scores():
    ...
    for query, expected_tier, min_confidence in test_cases:
        ...
        assert 0.0 <= decision.confidence <= 1.0, "Confidence should be between 0 and 1"
