...
def test_no_summarization_loss():
    ...
    print("✓ Added turn with specific error code: 500")
    ...
    print("\n✓ After FIFO deletion:")
    print("  - First turn (with error 500) is deleted")
    print("  - Recent 2 turns are PERFECTLY intact")
    print("  - No summarization = No information loss")
...
def test_conversation_statistics():
    ...
    print(
        f"  ✅ Sliding window deleted {stats['deleted_turns']} old turns, kept {stats['current_turns']} recent!"
    )
