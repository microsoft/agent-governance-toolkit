...
def test_search_with_time_decay():
    ...
    doc1 = Document(
        ...
        sections=[
            Section(
                title="Introduction",
                content="How to reset the server using the new method.",
                weight=1.0,
            )
        ],
    ...
    doc2 = Document(
        ...
        sections=[
            Section(
                title="Introduction", content="How to reset the server. Old method.", weight=1.0
            )
        ],
    ...
    doc3 = Document(
        ...
        format=ContentFormat.TEXT,
        detected_type=DocumentType.TECHNICAL_DOCUMENTATION,
        sections=[Section(title="Introduction", content="Server reset from 2020.", weight=1.0)],
...
def test_context_extraction_with_decay():
    ...
    context_no_decay, metadata_no_decay = extractor_no_decay.extract_context(
