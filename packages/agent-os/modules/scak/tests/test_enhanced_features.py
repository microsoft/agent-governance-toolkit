...
class TestSemanticAnalysis:
    ...
    def test_semantic_analysis_with_tool_context(self):
        ...
        telemetry = [
            ToolExecutionTelemetry(
                tool_name="search_db", tool_status=ToolExecutionStatus.EMPTY_RESULT, tool_result=[]
            )
        ]
...
class TestNudgeMechanism:
    ...
    def test_should_nudge_on_giveup(self):
        ...
        outcome = analyzer.analyze_outcome(
            agent_id="test-agent", user_prompt="Find data", agent_response="Cannot find data."
        )
    ...
    def test_max_nudges_limit(self):
        ...
        outcome2 = analyzer.analyze_outcome(
            agent_id="test-agent", user_prompt="Find more data", agent_response="Cannot find data."
        )
    ...
    def test_nudge_stats(self):
        ...
        outcome2 = analyzer.analyze_outcome(
            agent_id="test-agent2", user_prompt="Find data", agent_response="Cannot find data."
        )
...
class TestKernelIntegration:
    ...
    def test_kernel_with_tool_telemetry(self):
        ...
        kernel = SelfCorrectingAgentKernel(config={"use_semantic_analysis": True})
    ...
    def test_value_delivery_metrics(self):
        ...
        kernel.handle_outcome(
            agent_id="test-agent", user_prompt="Find more data", agent_response="No data found."
        )
...
class TestSemanticAnalyzerEdgeCases:
    ...
    def test_very_short_response(self):
        ...
        result = analyzer.analyze(agent_response="No.", user_prompt="Find data")
