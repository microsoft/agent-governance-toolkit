...
from src.kernel.load_testing import LoadProfile, LoadTester
...
class TestCircuitBreaker:
    ...
    def breaker(self):
        ...
        return CircuitBreaker("test_service", failure_threshold=3, timeout_seconds=2)
...
class TestHealthMonitor:
    ...
    def monitor(self):
        ...
        return HealthMonitor(check_interval_seconds=1, unhealthy_threshold=2)
    ...
    async def test_register_component(self, monitor):
        ...
        monitor.register_component("component-1", "agent", health_check)
...
class TestFailoverManager:
    ...
    def manager(self):
        ...
        # Track health states
        health_states = {"primary": True, "backup": True}
...
class TestLoadTester:
    ...
    async def test_spike_load_test(self, tester):
        ...
        result = await tester.run_load_test(
            target_function, profile=LoadProfile.SPIKE, total_requests=30, concurrent_requests=15
        )
    ...
    async def test_error_rate_tracking(self, tester):
        ...
        result = await tester.run_load_test(
            target_function, profile=LoadProfile.RAMP_UP, total_requests=50, concurrent_requests=10
        )
    ...
    async def test_latency_percentiles(self, tester):
        ...
        result = await tester.run_load_test(
            target_function, profile=LoadProfile.SPIKE, total_requests=20, concurrent_requests=5
        )
