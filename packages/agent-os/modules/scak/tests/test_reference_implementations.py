...
from agent_kernel.memory_manager import LessonType, MemoryManager
...
class TestMemoryManager(unittest.TestCase):
    ...
    def test_add_syntax_lesson(self):
        ...
        self.manager.add_lesson("Always output JSON format", LessonType.SYNTAX)
    ...
    def test_add_business_lesson(self):
        ...
        self.manager.add_lesson("Fiscal year starts in October", LessonType.BUSINESS)
    ...
    def test_add_one_off_lesson(self):
        ...
        self.manager.add_lesson("Server maintenance on 2024-01-15", LessonType.ONE_OFF)
    ...
    def test_lesson_metadata(self):
        ...
        self.manager.add_lesson("Test lesson", LessonType.BUSINESS)
...
class TestIntegration(unittest.TestCase):
    ...
    def test_full_workflow(self):
        ...
        diagnosis = asyncio.run(
            diagnose_failure("Find user records", agent_response, "search_users(limit=10)")
        )
        self.assertIn("lesson_patch", diagnosis)
