...
class ExecutionAgent:
    ...
    def register_action_handler(
        self, action_id: str, handler: Callable[[Dict[str, Any]], Dict[str, Any]]
    ) -> None:
        """
    ...
    def execute(self, session_id: str) -> HandshakeSession:
        ...
        try:
            ...
            result = self._execute_action(
                session.proposal.action_id, session.proposal.parameters, session.proposal.context
            )
    ...
    def _execute_action(
        self, action_id: str, parameters: Dict[str, Any], context: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
