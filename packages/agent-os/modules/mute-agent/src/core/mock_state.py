...
class MockState:
    ...
    def advance_time(self, seconds: float = 0, minutes: float = 0, hours: float = 0):
        """
    ...
    def get_recent_events(
        self, count: int = 10, event_type: Optional[ContextEventType] = None
    ) -> List[ContextEvent]:
        """
...
def create_stale_pointer_scenario(
    service_a: str = "svc-a", service_b: str = "svc-b", time_gap_minutes: float = 10.0
) -> MockState:
    """
