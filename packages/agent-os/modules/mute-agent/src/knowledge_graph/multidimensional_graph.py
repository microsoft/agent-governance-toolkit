...
from .graph_elements import Edge, EdgeType, Node, NodeType
from .subgraph import Dimension, Subgraph
...
class MultidimensionalKnowledgeGraph:
    ...
    def find_relevant_dimensions(self, context: Dict[str, Any]) -> List[str]:
        ...
        # Sort by priority
        relevant_dimensions.sort(key=lambda d: self.dimensions[d].priority, reverse=True)
    ...
    def get_pruned_action_space(self, dimension_name: str, context: Dict[str, Any]) -> List[Node]:
        """
    ...
    def validate_action_across_dimensions(
        self, action_id: str, dimension_names: List[str], context: Optional[Dict[str, Any]] = None
    ) -> bool:
        """
    ...
    def find_all_missing_dependencies(
        self, action_id: str, dimension_names: List[str], context: Dict[str, Any]
    ) -> Dict[str, List[str]]:
        """
    ...
    def get_action_constraints(self, action_id: str, dimension_name: str) -> List[Node]:
