...
class MockControlPlaneClient:
    ...
    def register_agent(
        self, agent_id: str, agent_type: str, capabilities: List[str], metadata: Dict[str, Any]
    ) -> AgentInfo:
    ...
    def update_agent_state(self, agent_id: str, state: AgentLifecycleState) -> AgentInfo:
        """Mock state update."""
        if agent_id in self._agents:
    ...
    def enqueue_action(self, agent_id: str, action: Dict[str, Any]) -> str:
...
class ControlPlaneAdapter(BaseLayerAdapter):
    ...
    def register_agent(
        ...
        return self._client.register_agent(agent_id, agent_type, capabilities or [], metadata or {})
    ...
    def enqueue_action(
        self, agent_id: str, action_type: str, parameters: Dict[str, Any], priority: int = 0
    ) -> str:
        """
        ...
        """
        self.ensure_connected()
        return self._client.enqueue_action(
            agent_id,
            {
                "type": action_type,
