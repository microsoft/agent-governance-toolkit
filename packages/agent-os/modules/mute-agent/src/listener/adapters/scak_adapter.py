...
class MockSCAKClient:
    ...
    def validate(self, graph_id: str, action_id: str, context: Dict[str, Any]) -> ValidationResult:
        """Mock validation."""
    ...
    def get_action_space(self, graph_id: str, dimensions: List[str]) -> List[str]:
...
class IntelligenceAdapter(BaseLayerAdapter):
    ...
    def query_graph(self, graph_id: str, query: Dict[str, Any]) -> GraphQueryResult:
        """
    ...
    def validate_action(
        self, graph_id: str, action_id: str, context: Dict[str, Any]
    ) -> ValidationResult:
        """
    ...
    def get_pruned_action_space(
        self, graph_id: str, dimensions: List[str], context: Optional[Dict[str, Any]] = None
    ) -> List[str]:
        """
    ...
    def get_dimension_metadata(self, graph_id: str, dimension_name: str) -> Dict[str, Any]:
        """
    ...
    def find_constraints(self, graph_id: str, action_id: str) -> List[Dict[str, Any]]:
        """
