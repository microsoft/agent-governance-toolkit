...
class HandshakeProtocol:
    ...
    def initiate_handshake(self, proposal: ActionProposal) -> HandshakeSession:
        ...
        session = HandshakeSession(
            session_id=session_id, state=HandshakeState.INITIATED, proposal=proposal
        )
        self.sessions[session_id] = session
        return session

    def validate_proposal(
        self, session_id: str, validation_result: ValidationResult
    ) -> HandshakeSession:
        """
        ...
        session.state = (
            HandshakeState.VALIDATED if validation_result.is_valid else HandshakeState.REJECTED
        )
    ...
    def reject_proposal(self, session_id: str, reason: str) -> HandshakeSession:
    ...
    def complete_execution(self, session_id: str, result: Dict[str, Any]) -> HandshakeSession:
    ...
    def fail_execution(self, session_id: str, error: str) -> HandshakeSession:
