...
class SuperSystemRouter:
    ...
    def route(self, context: Dict[str, Any]) -> RoutingResult:
        ...
        pruned_action_space = self._intersect_action_spaces(action_spaces, relevant_dimensions)
    ...
    def _intersect_action_spaces(
        self, action_spaces: Dict[str, List[Node]], dimension_names: List[str]
    ) -> List[Node]:
        """
    ...
    def get_routing_statistics(self) -> Dict[str, Any]:
        ...
        total_dimensions = sum(len(result.selected_dimensions) for result in self.routing_history)
        total_actions = sum(len(result.pruned_action_space) for result in self.routing_history)
