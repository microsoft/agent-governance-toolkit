...
class MockIATPClient:
    ...
    def check_permission(
        self, actor_id: str, permission: str, resource: Optional[str] = None
    ) -> PermissionCheck:
    ...
    def emergency_alert(self, reason: str, triggered_rules: List[str]) -> str:
...
class SecurityAdapter(BaseLayerAdapter):
    ...
    def emergency_alert(
        self, reason: str, triggered_rules: List[str], context: Optional[Dict[str, Any]] = None
    ) -> str:
        """
    ...
    def detect_permission_escalation(
        self, actor_id: str, requested_permissions: List[str], current_permissions: List[str]
    ) -> bool:
        """
