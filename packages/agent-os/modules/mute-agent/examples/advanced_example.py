...
def setup_action_handlers(execution_agent):
    ...
    def notify_handler(params):
        return {"sent": True, "recipients": params.get("recipients", []), "message_id": "msg_67890"}

    def report_handler(params):
        return {"report_generated": True, "format": params.get("format", "pdf"), "size_kb": 156}
...
def scenario_3_action_selection(reasoning_agent):
    ...
    context = {"user_role": "user", "authenticated": True, "operation": "read"}
