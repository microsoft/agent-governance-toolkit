...
from amb_core.persistence import InMemoryMessageStore, MessageStatus, MessageStore
from amb_core.schema import SchemaRegistry
from amb_core.tracing import get_current_trace
...
class MessageBus:
    ...
    async def subscribe(self, topic: str, handler: MessageHandler, *, with_dlq: bool = True) -> str:
        """
