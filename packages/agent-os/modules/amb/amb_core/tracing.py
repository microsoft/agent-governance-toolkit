...
class TraceContext:
    ...
    def new(cls, operation_name: str = "root") -> "TraceContext":
        ...
        ctx = cls(trace_id=trace_id, span_id=span_id, parent_span_id=None)

        # Create root span
        root_span = TraceSpan(span_id=span_id, operation_name=operation_name, trace_id=trace_id)
    ...
    def from_headers(cls, headers: Dict[str, str]) -> "TraceContext":
        ...
        return cls(
            trace_id=trace_id, span_id=span_id, parent_span_id=parent_span_id, baggage=baggage
        )
