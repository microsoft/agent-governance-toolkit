...
class PydanticSchema(Schema):
    ...
    def validate(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            raise SchemaValidationError(topic="unknown", errors=e.errors(), payload=payload)
    ...
    def validate(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for field, expected_type in self._spec.items():
            if field not in payload:
                errors.append(
                    {"type": "missing", "loc": [field], "msg": f"Field '{field}' is required"}
                )
        ...
        if errors:
            raise SchemaValidationError(topic="unknown", errors=errors, payload=payload)
...
class SchemaRegistry:
    ...
    def register(
        self, topic: str, schema: Union[Type[BaseModel], Dict[str, type], Schema, Callable]
    ) -> None:
        """
    ...
    def validate(self, topic: str, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            raise SchemaValidationError(topic=topic, errors=e.errors, payload=e.payload)
