...
class TestCloudEvent:
    ...
    def test_create_minimal_event(self):
        ...
        event = CloudEvent(id="evt-123", source="/agent-os/test", type="dev.agent-os.test.event")
    ...
    def test_specversion_validation(self):
        ...
        with pytest.raises(ValueError, match="Unsupported specversion"):
            CloudEvent(id="evt-123", source="/test", type="test.event", specversion="0.3")

    def test_source_validation(self):
        """Test that empty source is rejected."""
        with pytest.raises(ValueError, match="source cannot be empty"):
            CloudEvent(id="evt-123", source="", type="test.event")

    def test_type_validation(self):
        """Test that empty type is rejected."""
        with pytest.raises(ValueError, match="type cannot be empty"):
            CloudEvent(id="evt-123", source="/test", type="")

    def test_to_json(self):
        """Test JSON serialization."""
        event = CloudEvent(id="evt-123", source="/test", type="test.event", data={"key": "value"})
    ...
    def test_to_dict(self):
        ...
        event = CloudEvent(id="evt-123", source="/test", type="test.event")
...
class TestMessageConversion:
    ...
    def test_to_cloudevent_with_priority(self):
        ...
        message = Message(
            id="msg-123", topic="fraud.alerts", payload={}, priority=MessagePriority.CRITICAL
        )
    ...
    def test_to_cloudevent_with_ttl(self):
        ...
        message = Message(id="msg-123", topic="test", payload={}, ttl=300)
    ...
    def test_to_cloudevent_custom_prefix(self):
        ...
        message = Message(id="msg-123", topic="fraud.alerts", payload={})
    ...
    def test_from_cloudevent_with_priority(self):
        ...
        event = CloudEvent(
            id="evt-123", source="/test", type="test.event", ambpriority=MessagePriority.HIGH.value
        )
...
class TestCloudEventBatch:
    ...
    def test_create_batch(self):
        ...
        events = [CloudEvent(id=f"evt-{i}", source="/test", type="test.event") for i in range(3)]
