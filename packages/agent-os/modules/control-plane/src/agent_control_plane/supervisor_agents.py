...
class SupervisorAgent:
    ...
    def watch_execution_logs(self, execution_log: List[Dict[str, Any]]) -> List[Violation]:
        ...
        relevant_logs = [log for log in execution_log if log.get("agent_id") in self.config.watches]
...
def detect_repeated_failures(
    logs: List[Dict[str, Any]], supervisor: SupervisorAgent
) -> List[Violation]:
...
def detect_rate_limit_approaching(
    logs: List[Dict[str, Any]], supervisor: SupervisorAgent
) -> List[Violation]:
...
class SupervisorNetwork:
    ...
    def get_network_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "supervisors": {
                sid: supervisor.get_summary() for sid, supervisor in self.supervisors.items()
            },
        }
