...
class A2AAdapter:
    ...
    def __init__(
        ...
        self.logger.info(f"Initialized A2AAdapter for agent {agent_context.agent_id}")
    ...
    def _handle_task_request(self, payload: Dict, from_agent: str) -> Dict:
        ...
        check_result = self.control_plane.execute_action(
            self.agent_context, action_type, task_params
        )
    ...
    def _handle_task_delegation(self, payload: Dict, from_agent: str) -> Dict:
        ...
        check_result = self.control_plane.execute_action(
            self.agent_context, action_type, {"target_agent": target_agent, "task_type": task_type}
        )
        ...
        return {"status": "delegated", "target_agent": target_agent, "task_type": task_type}
    ...
    def _handle_query(self, payload: Dict, from_agent: str) -> Dict:
        ...
        check_result = self.control_plane.execute_action(
            self.agent_context, action_type, query_params
        )
        ...
        return {"status": "success", "data": check_result.get("result", {})}
    ...
    def _handle_discovery(self, payload: Dict, from_agent: str) -> Dict:
        ...
        return {"agent_card": self.agent_card, "agent_id": self.agent_context.agent_id}
    ...
    def _handle_handshake(self, payload: Dict, from_agent: str) -> Dict:
        ...
        return {"status": "connected", "agent_card": self.agent_card}
    ...
    def _handle_negotiate(self, payload: Dict, from_agent: str) -> Dict:
        ...
        return {"status": "accepted", "parameters": proposed_params}
    ...
    def discover_agents(self) -> List[Dict]:
        ...
        return [{"agent_id": agent_id, **card} for agent_id, card in self.peer_agents.items()]
...
class A2AAgent:
    ...
    def send_task_request(self, to_agent: str, task_type: str, parameters: Dict) -> Dict:
        ...
        message = {
            ...
            "to": to_agent,
            "timestamp": datetime.now().isoformat(),
            "payload": {"task_type": task_type, "parameters": parameters},
        }
