...
class KernelInterface(ABC):
    ...
    @abstractmethod
    def create_session(self, agent_id: str, permissions: Optional[Dict[str, Any]] = None) -> Any:
        """
    ...
    @abstractmethod
    def submit_request(self, session_id: str, action_type: str, parameters: Dict[str, Any]) -> Any:
        """
...
class SelfCorrectingKernelInterface(KernelInterface):
    ...
    @abstractmethod
    def record_outcome(
        self, request_id: str, outcome: str, feedback: Optional[Dict[str, Any]] = None
    ) -> None:
        """
    ...
    @abstractmethod
    def get_correction_suggestions(self, request: Any) -> List[Dict[str, Any]]:
        """
    ...
    @abstractmethod
    def apply_learned_policy(self, policy_id: str, confidence_threshold: float = 0.8) -> bool:
        """
...
class CapabilityRestrictedKernelInterface(KernelInterface):
    ...
    def validate_against_capabilities(
        self, agent_id: str, action_type: str, parameters: Dict[str, Any]
    ) -> tuple[bool, Optional[str]]:
        """
