...
class ExecutionEngine:
    ...
    def execute(
        self, request: ExecutionRequest, context: Optional[ExecutionContext] = None
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            result = self._execute_with_timeout(executor, request, context, metrics)
            ...
            return {
                ...
                "result": result,
                "metrics": {
                    "execution_time_ms": (metrics.end_time - metrics.start_time).total_seconds()
                    * 1000,
