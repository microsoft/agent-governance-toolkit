...
class ToolRegistry:
    ...
    def execute_tool(self, tool_id_or_name: str, parameters: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        if not tool:
            return {"success": False, "error": f"Tool '{tool_id_or_name}' not found"}
    ...
    def validate_parameters(
        self, tool_id_or_name: str, parameters: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
