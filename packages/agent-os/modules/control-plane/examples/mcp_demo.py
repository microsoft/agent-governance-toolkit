...
def demo_basic_mcp_server():
    ...
    print("✓ Server name: file-server")
    print("✓ Transport: stdio (standard input/output)")
    print("✓ Permissions: READ_ONLY for files and database")
...
def demo_mcp_resources():
    ...
    list_request = {"jsonrpc": "2.0", "id": 1, "method": "resources/list", "params": {}}
...
def demo_mcp_error_handling():
    ...
    write_request = {
        ...
        "params": {
            "name": "write_file",
            "arguments": {"path": "/data/output.txt", "content": "This should be blocked"},
        },
    }
