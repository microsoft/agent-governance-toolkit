...
def example_eu_ai_act_compliance():
    ...
    result = engine.check_compliance(
        framework=RegulatoryFramework.EU_AI_ACT, context=compliant_context
    )
    ...
    non_compliant_context = {"human_oversight_enabled": False, "provides_transparency_info": False}

    result = engine.check_compliance(
        framework=RegulatoryFramework.EU_AI_ACT, context=non_compliant_context
    )
...
def example_risk_assessment():
    ...
    systems = [
        {"name": "Simple Chatbot", "description": {"type": "general chatbot"}},
        {
            "name": "Recruitment System",
            "description": {"type": "employment decision system", "domain": "employment"},
        },
        {"name": "Social Scoring System", "description": {"type": "social_scoring system"}},
    ]
...
def example_soc2_compliance():
    ...
    result = engine.check_compliance(framework=RegulatoryFramework.SOC2, context=system_context)

    print("SOC 2 Trust Service Criteria:")
    print(f"  Compliant: {result.compliant}")
...
def example_constitutional_ai():
    ...
    good_response = (
        "I'd be happy to help you with that task. Let me know if you need clarification."
    )
...
def example_integrated_compliance():
    ...
    eu_compliance = compliance_engine.check_compliance(
        RegulatoryFramework.EU_AI_ACT, system_context
    )

    soc2_compliance = compliance_engine.check_compliance(RegulatoryFramework.SOC2, system_context)
