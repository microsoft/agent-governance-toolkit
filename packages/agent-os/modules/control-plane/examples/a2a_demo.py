...
def demo_basic_a2a_agent():
    ...
    print("✓ Agent ID: data-processor-agent")
    print("✓ Name: Data Processor")
    print("✓ Permissions: READ_ONLY for database, READ_WRITE for API and workflows\n")
...
def demo_task_request():
    ...
    task_request = {
        ...
        "payload": {
            ...
            "parameters": {"data": [1, 2, 3, 4, 5], "count": 5},
        },
    }
...
def demo_task_delegation():
    ...
    delegation_request = {
        ...
        "payload": {
            ...
            "parameters": {"data_source": "database", "analysis_type": "deep"},
        },
    }
...
def demo_agent_discovery():
    ...
    agent2 = create_governed_a2a_agent(
        ...
        agent_card={"name": "File Handler", "capabilities": ["file_reading", "file_analysis"]},
    ...
    agent3 = create_governed_a2a_agent(
        ...
        agent_card={"name": "API Connector", "capabilities": ["api_calls", "data_fetching"]},
