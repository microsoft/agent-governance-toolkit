...
class TestHealthMonitor:
    ...
    async def test_custom_health_check(self, health_config):
        ...
        monitor.register_agent("test-agent", MockAgent(), custom_liveness=custom_liveness)
...
class TestCircuitBreaker:
    ...
    async def test_closes_after_successful_half_open(self):
        ...
        config = CircuitBreakerConfig(
            failure_threshold=1, success_threshold=2, recovery_timeout_seconds=0.1
        )
        breaker = CircuitBreaker(name="test", config=config)
...
class TestAgentScaler:
    ...
    async def test_register_agent_type(self):
        ...
        scaler.register_agent_type(agent_type="test-agent", factory=lambda: MockAgent(), replicas=2)
...
class TestGracefulShutdown:
    ...
    async def test_register_operation(self):
        ...
        op_id = manager.register_operation(
            agent_id="test-agent", operation_type="verification", data={"claim_id": "123"}
        )
...
class TestResourceQuotas:
    ...
    def test_set_quota(self):
        ...
        quota = AgentResourceQuota(memory_mb=512, cpu_percent=25.0, max_concurrent_operations=10)
    ...
    def test_can_execute_within_quota(self):
        ...
        manager = ResourceQuotaManager()
        manager.set_quota("test-agent", AgentResourceQuota(max_concurrent_operations=10))
    ...
    def test_cannot_execute_at_limit(self):
        ...
        manager = ResourceQuotaManager()
        manager.set_quota("test-agent", AgentResourceQuota(max_concurrent_operations=2))
    ...
    def test_check_quota_violations(self):
        ...
        manager = ResourceQuotaManager()
        manager.set_quota("test-agent", AgentResourceQuota(memory_mb=512, cpu_percent=25.0))
...
class TestAgentObservability:
    ...
    def test_record_metric(self):
        ...
        provider.record_metric(
            agent_id="test-agent", name="latency_ms", value=150.5, labels={"operation": "verify"}
        )
    ...
    def test_log_entry(self):
        ...
        provider.log(
            agent_id="test-agent", level="info", message="Test message", context={"key": "value"}
        )
...
class TestHotReload:
    ...
    def test_register_agent(self):
        ...
        manager.register_agent(
            agent_id="test-agent", module_name="test_module", class_name="TestAgent"
        )
...
class TestEnhancedControlPlane:
    ...
    def test_create_control_plane(self):
        ...
        control_plane = create_control_plane(health_check_interval=30.0, auto_recovery=True)
    ...
    def test_register_agent(self):
        ...
        agent_id = control_plane.register(MockAgent, replicas=2, dependencies=[])
    ...
    def test_register_with_resources(self):
        ...
        control_plane.register(
            MockAgent, replicas=1, resources=AgentResourceQuota(memory_mb=512, cpu_percent=25)
        )
    ...
    def test_register_with_circuit_breaker(self):
        ...
        control_plane.register(MockAgent, circuit_breaker=breaker)
...
class TestIntegration:
    ...
    async def test_full_lifecycle(self):
        ...
        control_plane = create_control_plane(health_check_interval=1.0, auto_recovery=True)
    ...
    async def test_dependency_order(self):
        ...
        control_plane.register(lambda: TrackedAgent("cache"), agent_id="cache", replicas=1)
        control_plane.register(lambda: TrackedAgent("database"), agent_id="database", replicas=1)
        control_plane.register(
