...
class TestPrometheusExporter(unittest.TestCase):
    ...
    def test_increment_counter(self):
        ...
        self.exporter.increment_counter("test_counter", value=1.0, labels={"service": "test"})
    ...
    def test_set_gauge(self):
        ...
        self.exporter.set_gauge("test_gauge", value=42.0, labels={"service": "test"})
    ...
    def test_observe_histogram(self):
        ...
        self.exporter.observe_histogram("test_histogram", value=0.5, labels={"service": "test"})
...
class TestTraceCollector(unittest.TestCase):
    ...
    def test_start_span(self):
        ...
        span_id = self.collector.start_span(trace_id=trace_id, operation_name="sub_operation")
    ...
    def test_end_span(self):
        """Test ending a span"""
        trace_id = self.collector.start_trace("test")
        span_id = self.collector.start_span(trace_id=trace_id, operation_name="sub_op")
    ...
    def test_nested_spans(self):
        ...
        trace_id = self.collector.start_trace("test")
        parent_span = self.collector.start_span(trace_id=trace_id, operation_name="parent")
        child_span = self.collector.start_span(
            trace_id=trace_id, operation_name="child", parent_span_id=parent_span
        )
...
class TestObservabilityDashboard(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.dashboard = ObservabilityDashboard(self.prometheus, self.alerts, self.traces)
    ...
    def test_get_health_status_degraded(self):
        ...
        self.alerts.add_rule(
            name="error", condition=lambda m: True, severity=AlertSeverity.ERROR, message="Error"
        )
