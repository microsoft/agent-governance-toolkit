...
class TestMCPAdapter(unittest.TestCase):
    ...
    def test_create_adapter(self):
        ...
        adapter = MCPAdapter(control_plane=control_plane, agent_context=agent_context)
    ...
    def test_register_resource(self):
        ...
        resource_info = {"uri": "file://", "name": "Files", "description": "File resources"}
    ...
    def test_tools_call_allowed(self):
        ...
        message = {
            ...
            "id": 1,
            "method": "tools/call",
            "params": {"name": "read_file", "arguments": {"path": "/data/test.txt"}},
        }
    ...
    def test_custom_tool_mapping(self):
        ...
        adapter = MCPAdapter(
            control_plane=control_plane, agent_context=agent_context, tool_mapping=custom_mapping
        )
    ...
    def test_map_tool_to_action(self):
        ...
        self.assertEqual(adapter._map_tool_to_action("read_file"), ActionType.FILE_READ)
        self.assertEqual(adapter._map_tool_to_action("sql_query"), ActionType.DATABASE_QUERY)
        self.assertEqual(adapter._map_tool_to_action("api_request"), ActionType.API_CALL)
    ...
    def test_map_resource_to_action(self):
        ...
        self.assertEqual(
            adapter._map_resource_to_action("file:///data/test.txt"), ActionType.FILE_READ
        )
        self.assertEqual(
            adapter._map_resource_to_action("postgres://localhost/db"), ActionType.DATABASE_QUERY
        )
        self.assertEqual(
            adapter._map_resource_to_action("https://api.example.com"), ActionType.API_CALL
        )
