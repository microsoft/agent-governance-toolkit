...
class TestLangChainAdapter(unittest.TestCase):
    ...
    def test_create_adapter(self):
        ...
        adapter = LangChainAdapter(
            control_plane=control_plane, agent_context=agent_context, langchain_client=llm
        )
    ...
    def test_custom_tool_mapping(self):
        ...
        self.assertEqual(adapter.tool_mapping["company_file_tool"], ActionType.FILE_READ)
    ...
    def test_pattern_matching(self):
        ...
        self.assertEqual(adapter._map_tool_to_action("read_file_content"), ActionType.FILE_READ)
        self.assertEqual(
            adapter._map_tool_to_action("execute_python_code"), ActionType.CODE_EXECUTION
        )
        self.assertEqual(adapter._map_tool_to_action("query_database"), ActionType.DATABASE_QUERY)
