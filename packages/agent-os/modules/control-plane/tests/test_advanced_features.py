...
from agent_control_plane.mute_agent import (
    create_mute_data_analyst,
    create_mute_sql_agent,
)
...
class TestMuteAgent(unittest.TestCase):
    ...
    def test_mute_sql_agent_valid_query(self):
        ...
        result = self.control_plane.execute_action(
            agent, ActionType.DATABASE_QUERY, {"query": "SELECT * FROM users"}
        )
    ...
    def test_mute_sql_agent_invalid_query(self):
        ...
        result = self.control_plane.execute_action(
            agent, ActionType.DATABASE_QUERY, {"query": "DROP TABLE users"}
        )
    ...
    def test_mute_agent_out_of_scope(self):
        ...
        result = self.control_plane.execute_action(
            agent, ActionType.FILE_READ, {"path": "/data/file.txt"}
        )
        self.assertFalse(result["success"])
    ...
    def test_data_analyst_capabilities(self):
        ...
        result = self.control_plane.execute_action(
            agent, ActionType.FILE_READ, {"path": "/data/analytics.csv"}
        )
        self.assertTrue(result["success"])
...
class TestShadowMode(unittest.TestCase):
    ...
    def test_shadow_mode_enabled(self):
        ...
        result = control_plane.execute_action(
            agent, ActionType.FILE_READ, {"path": "/data/test.txt"}
        )
    ...
    def test_shadow_mode_statistics(self):
        ...
        for i in range(3):
            control_plane.execute_action(
                agent, ActionType.FILE_READ, {"path": f"/data/file{i}.txt"}
            )
    ...
    def test_reasoning_chain(self):
        ...
        result = control_plane.execute_action(
            agent, ActionType.FILE_READ, {"path": "/data/test.txt"}, reasoning_chain=reasoning_chain
        )
...
class TestConstraintGraphs(unittest.TestCase):
    ...
    def test_data_graph_table_access(self):
        ...
        result = control_plane.execute_action(
            agent, ActionType.DATABASE_QUERY, {"table": "users", "query": "SELECT * FROM users"}
        )
        self.assertTrue(result["success"])

        # Try to access table NOT in graph - should fail
        result = control_plane.execute_action(
            agent, ActionType.DATABASE_QUERY, {"table": "secrets", "query": "SELECT * FROM secrets"}
        )
        self.assertFalse(result["success"])
    ...
    def test_data_graph_file_access(self):
        ...
        result = control_plane.execute_action(agent, ActionType.FILE_READ, {"path": "/etc/passwd"})
        self.assertFalse(result["success"])
...
class TestIntegration(unittest.TestCase):
    ...
    def test_full_integration(self):
        ...
        control_plane = AgentControlPlane(
            enable_default_policies=True, enable_shadow_mode=False, enable_constraint_graphs=True
        )
