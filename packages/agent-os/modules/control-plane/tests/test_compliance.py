...
class TestComplianceEngine(unittest.TestCase):
    ...
    def test_check_compliance_pass(self):
        ...
        context = {"human_oversight_enabled": True, "provides_transparency_info": True}

        result = self.engine.check_compliance(
            framework=RegulatoryFramework.EU_AI_ACT, context=context
        )
    ...
    def test_check_compliance_fail(self):
        ...
        context = {"human_oversight_enabled": False, "provides_transparency_info": False}
    ...
    def test_generate_compliance_report(self):
        ...
        report = self.engine.generate_compliance_report(framework=RegulatoryFramework.SOC2)
    ...
    def test_audit_trail(self):
        ...
        self.engine.check_compliance(framework=RegulatoryFramework.EU_AI_ACT, context=context)

        trail = self.engine.get_audit_trail(framework=RegulatoryFramework.EU_AI_ACT)
