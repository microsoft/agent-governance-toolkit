...
class FlightRecorder:
    ...
    def log_error(
        self, trace_id: str, agent_id: str, error: str, details: Optional[Dict[str, Any]] = None
    ) -> None:
    ...
    def log_user_override(
        self, trace_id: str, agent_id: str, warning: str, quarantine_session: QuarantineSession
    ) -> None:
...
class TraceIDGenerator:
    ...
    @staticmethod
    def create_context(
        trace_id: str, agent_id: str, parent_trace_id: Optional[str] = None
    ) -> TracingContext:
