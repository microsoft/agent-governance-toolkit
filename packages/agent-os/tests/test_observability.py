...
class TestKernelMetrics:
    ...
    def test_record_violation(self):
        ...
        try:
            ...
            metrics = KernelMetrics()
            metrics.record_violation(agent_id="test-agent", policy="read_only", action="file_write")
    ...
    def test_record_sigkill(self):
        ...
        try:
            ...
            metrics = KernelMetrics()
            metrics.record_sigkill(agent_id="test-agent", reason="policy_violation")
    ...
    def test_record_mttr(self):
        ...
        try:
            ...
            metrics = KernelMetrics()
            metrics.record_mttr(agent_id="test-agent", recovery_seconds=5.2)
...
class TestKernelTracer:
    ...
    def test_trace_execution(self):
        ...
        try:
            ...
            with tracer.trace_execution(
                agent_id="test-agent", action="database_query", params={"query": "SELECT 1"}
            ) as span:
    ...
    def test_trace_policy_check(self):
        ...
        try:
            ...
            with tracer.trace_policy_check(agent_id="test-agent", policy="strict"):
                pass
    ...
    def test_trace_signal(self):
        ...
        try:
            ...
            tracer.trace_signal(agent_id="test-agent", signal="SIGKILL", reason="policy_violation")
