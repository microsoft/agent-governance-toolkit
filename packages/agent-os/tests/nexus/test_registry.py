...
from nexus.schemas.manifest import AgentCapabilities, AgentIdentity, AgentManifest, AgentPrivacy
...
class TestAgentRegistry:
    ...
    async def test_verify_peer_success(self):
        ...
        for _ in range(50):
            registry.reputation_engine.record_task_outcome("did:nexus:test-agent", "success")
