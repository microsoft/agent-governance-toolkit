...
class CustomerSupportAgent:
    ...
    async def handle_ticket(self, ticket: Ticket) -> Response:
        ...
        kb_answer, sources, kb_confidence = self.kb.get_answer(f"{ticket.subject} {ticket.message}")
        ...
        requires_review = (
            ...
            or agreement < 0.8
            or len(violations) > 0
            or ticket.priority == Priority.URGENT
        )
