...
def scenario_undo_signal():
    ...
    doer = DoerAgent(stream_file=stream_file, enable_telemetry=True)
...
def scenario_abandonment_signal():
    ...
    last_response = (
        "You should check your code for type errors. Make sure variables are correct type."
    )
...
def observer_processing():
    ...
    observer = ObserverAgent(stream_file=stream_file, checkpoint_file=checkpoint_file)
