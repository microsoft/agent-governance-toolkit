...
def simulate_troubleshooting_conversation(verbose: bool = True):
    ...
    if verbose:
        ...
        print("Expected Evaluation: SUCCESS (resolved quickly)")
...
def simulate_troubleshooting_trapped(verbose: bool = True):
    ...
    if verbose:
        ...
        print("Expected Evaluation: FAILURE (user trapped, not engaged)")
...
def simulate_brainstorming_success(verbose: bool = True):
    ...
    if verbose:
        ...
        print(f"Detected Intent: {result['intent_type']}")
        print("Expected Evaluation: SUCCESS (deep exploration)")
...
def simulate_brainstorming_failure(verbose: bool = True):
    ...
    queries = ["Let's explore different database options", "Okay, I'll go with that"]
    ...
    if verbose:
        ...
        print(f"Detected Intent: {result['intent_type']}")
        print("Expected Evaluation: FAILURE (not creative enough)")
