...
def demo_complete_pipeline():
    ...
    for test_case in test_cases:
        ...
        input_context = context_mapping.get(context_obj.signal_type.value, InputContext.CHAT)
        ...
        print(
            f"   {context_obj.signal_type.value} → {poly_response.modality.value} → {ui_component.component_type}"
        )
...
def demo_backward_compatibility():
    ...
    print("  Component: Table with sorting and filtering")
