...
def test_capability():
    ...
    cap = Capability(
        name="math", description="Can do math", tags=["math", "calculations"], version="1.0"
    )
...
def test_constraint():
    ...
    con = Constraint(type="resource", description="No internet access", severity="high")
...
def test_agent_metadata_creation():
    ...
    metadata = AgentMetadata(
        agent_id="test-agent", name="Test Agent", version="1.0.0", description="A test agent"
    )
...
def test_add_capability():
    ...
    metadata.add_capability(name="math", description="Can do math", tags=["math"], version="1.0")
...
def test_add_constraint():
    ...
    metadata.add_constraint(type="resource", description="No internet", severity="high")
...
def test_set_trust_score():
    ...
    metadata.set_trust_score(success_rate=0.95, avg_latency_ms=1200.0, total_executions=100)
...
def test_to_dict_and_from_dict():
    ...
    metadata.set_io_contract(input_schema={"type": "string"}, output_schema={"type": "string"})
...
def test_validate_compatibility():
    ...
    metadata1 = manager1.create_manifest(
        agent_id="agent1", name="Agent 1", version="1.0.0", description="First agent"
    )
    metadata1.add_constraint("resource", "High severity issue", severity="high")

    metadata2 = AgentMetadata(
        agent_id="agent2", name="Agent 2", version="1.0.0", description="Second agent"
    )
