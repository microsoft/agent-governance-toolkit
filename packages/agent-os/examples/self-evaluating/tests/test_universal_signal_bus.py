...
def test_text_signal_normalizer():
    ...
    raw_signal = {"text": "Hello, how are you?", "user_id": "user123"}
...
def test_file_change_signal_normalizer():
    ...
    # Test file deletion
    raw_signal3 = {"file_path": "/workspace/config.json", "change_type": "deleted"}
...
def test_log_stream_signal_normalizer():
    ...
    # Test warning
    raw_signal2 = {"level": "WARNING", "message": "High memory usage: 85%"}
    ...
    # Test critical error
    raw_signal3 = {"level": "CRITICAL", "message": "Payment service down"}
...
def test_audio_stream_signal_normalizer():
    ...
    raw_signal2 = {"transcript": "Emergency! The server is down!", "speaker_id": "admin"}
    ...
    # Test question
    raw_signal3 = {"transcript": "I have a question about the API"}
...
def test_universal_signal_bus_basic():
    ...
    signal2 = create_signal_from_file_change("/app.py", "created", content_after="print('test')")
...
def test_priority_and_urgency():
    ...
    critical_log = create_signal_from_log("CRITICAL", "Payment service down", error_code="500")
    ...
    security_file = create_signal_from_file_change(
        "/auth/security.py", "modified", content_before="old", content_after="new"
    )
    ...
    urgent_audio = create_signal_from_audio("Emergency! Need help immediately!")
...
def test_edge_cases():
    ...
    no_change_file = create_signal_from_file_change(
        "/app.py", "modified", content_before="", content_after=""
    )
