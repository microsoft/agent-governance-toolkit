...
class ScoringRubric:
    ...
    def add_criteria(
        ...
        weight: float,
        description: str,
        evaluator: Optional[Callable[[str, str, Any], float]] = None,
    ) -> "ScoringRubric":
        """
        ...
        criteria = ScoringCriteria(
            dimension=dimension, weight=weight, description=description, evaluator=evaluator
        )
...
class EvaluationRunner:
    ...
    def __init__(
        self, dataset: EvaluationDataset, rubric: ScoringRubric, ai_function: Callable[[str], str]
    ):
        """
