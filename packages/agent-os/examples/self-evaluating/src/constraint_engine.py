...
class ConstraintEngine:
    ...
    def validate_plan(self, plan: Dict[str, Any], verbose: bool = False) -> ConstraintResult:
        ...
        result = ConstraintResult(approved=approved, violations=all_violations)
    ...
    def intercept_and_validate(
        self, plan: Dict[str, Any], execute_fn=None, verbose: bool = False
    ) -> Tuple[bool, Any, ConstraintResult]:
        """
...
def create_default_engine(
    max_cost: float = 0.05, allowed_domains: Optional[List[str]] = None
) -> ConstraintEngine:
    """
