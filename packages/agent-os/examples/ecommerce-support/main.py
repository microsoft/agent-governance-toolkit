...
class EcommerceSupportAgent:
            ...
            self.policy = create_policy(
                {
                    ...
                    "rules": [
                        ...
                        {"action": "view_payment", "mask": True, "audit": True},
                    ],
                }
            )
    ...
    async def verify_identity(self, customer_id: str, verification_code: str) -> bool:
    ...
    async def process_refund(self, order_id: str, reason: str, amount: float = None) -> dict:
        """
...
async def demo():
    ...
    customer = Customer(
        ...
        name="Jane Doe",
        payment_methods=[{"type": "visa", "last_four": "4242", "expiry": "12/25"}],
    )
