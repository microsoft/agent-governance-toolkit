...
# Initialize kernel
kernel = KernelSpace(policy_file="policies.yaml" if os.path.exists("policies.yaml") else "strict")
...
async def interactive_chat():
    ...
    while True:
        try:
            ...
            try:
                response = await kernel.execute(chat_agent, user_input, conversation_id)
                print(f"\nAgent: {response}\n")
