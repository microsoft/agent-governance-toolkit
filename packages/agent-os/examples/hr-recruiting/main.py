...
class BiasGuard:
    ...
    def sanitize_input(data: dict) -> dict:
        ...
        for key, value in data.items():
            ...
            is_protected = any(protected in key_lower for protected in PROTECTED_CHARACTERISTICS)
...
class HRRecruitingAgent:
            ...
            self.policy = create_policy(
                {
                    ...
                    "rules": [
                        ...
                        {"action": "reject_candidate", "require": ["bias_check_passed"]},
                    ],
                }
            )
    ...
    def add_candidate(self, candidate: Candidate):
        ...
        # Set retention date
        candidate.retention_until = candidate.applied_date + timedelta(days=self.retention_rejected)
    ...
    async def screen_candidate(self, candidate_id: str, job_id: str) -> dict:
        ...
        if decision == Decision.REJECT:
            ...
            if not reason_ok:
                ...
                self.audit_log.log("bias_blocked", candidate_id, job_id, reason=bias_issue)
    ...
    def _calculate_score(self, candidate: Candidate, job: JobRequirement) -> dict:
        ...
        if job.required_education:
            edu_match = (
                1.0
                if candidate.education.lower() in [e.lower() for e in job.required_education]
                else 0.5
            )
        else:
            edu_match = 1.0
...
async def demo():
    ...
    for c in candidates:
        ...
        print(
            f"   Breakdown: Skills={result['breakdown']['skills']}, "
