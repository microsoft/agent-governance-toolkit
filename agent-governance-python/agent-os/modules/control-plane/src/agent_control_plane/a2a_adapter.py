...
Usage:
    ...
    # Governance wraps each handled message. Note: in Public Preview the
    # transport in `start()` is a placeholder, so wire the governed handlers
    # into your own A2A runtime rather than relying on this loop.
    a2a_agent.start()
"""
